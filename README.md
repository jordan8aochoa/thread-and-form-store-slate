...
A single-brand embroidered-goods store built with Next.js App Router, TypeScript, Tailwind CSS, Supabase, Stripe Checkout, EasyPost, Resend, and Zod. Guest checkout is the default. The starter products, photographs, policies, and address are examples to replace before launch.
